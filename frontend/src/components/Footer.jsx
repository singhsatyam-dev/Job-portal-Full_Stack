  ...
  return (
    <footer className="mt-auto" style={{ borderTop: "1px solid var(--border)", background: "var(--bg-secondary)" }}>
      <div className="max-w-7xl mx-auto px-6 pt-10 pb-6">
        <div className="flex flex-wrap gap-8 justify-between mb-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed max-w-xs" style={{ color: "var(--text-muted)" }}>
              The AI-powered job portal connecting talented professionals with their dream careers.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-xs uppercase tracking-widest mb-3" style={{ color: "var(--text-secondary)" }}>
              Quick Links
            </h4>
        ...
        <div className="flex justify-center items-center gap-1.5 text-xs" style={{ color: "var(--text-muted)" }}>
          <span>Made with</span>
